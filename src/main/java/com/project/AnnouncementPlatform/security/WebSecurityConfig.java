...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/api/scholarships/**").permitAll()
                .antMatchers("/api/scholarship/**").permitAll()
                .antMatchers("/api/userJobAttributes/**").permitAll()
                .antMatchers("/api/userSchoralshipAttributes/**").permitAll()
                .antMatchers("/api/userVolunteerAttributes/**").permitAll()
                .antMatchers("/api/voluntarinesses/**").permitAll()
                .antMatchers("/api/voluntariness/**")
                .permitAll()
