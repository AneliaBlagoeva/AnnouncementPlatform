...
public class UserSchoralshipAttributesController {
	...
	@CrossOrigin(origins = "http://localhost:4200")
	public ResponseEntity<UserSchoralshipAttributes> getUserSchoralshipAttributesByEmail(@PathVariable String email) {
		Optional<UserSchoralshipAttributes> userSchoralshipAttributes=userSchoralshipAttributesService.findById(email);
	...
	@PutMapping("/userSchoralshipAttributes/{email}")
	@CrossOrigin(origins = "http://localhost:4200")
    public ResponseEntity<UserSchoralshipAttributes> update(@PathVariable String email, @Valid @RequestBody UserSchoralshipAttributes product) {
